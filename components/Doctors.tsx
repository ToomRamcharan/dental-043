        ...
        <div className="grid md:grid-cols-3 gap-8">
          {doctors.map((d, i) => (
            <motion.div key={i} initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: i * 0.15 }}
              ...
              <div className="h-48 flex items-center justify-center" style={{background: 'linear-gradient(135deg, #14b8a6 0%, #0d9488 40%, #a855f7 100%)'}}>
              ...
              <div className="p-6">
                ...
                <p className="text-sm font-medium mb-2" style={{color: '#14b8a6'}}>{d.specialty}</p>
